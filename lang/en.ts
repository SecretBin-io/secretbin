...
export default {
  ...
  Translations: {
    ...
    ViewSecret: {
      Title: "Secret",
      Description: "You were sent this secret message. It is meant for your eyes only. Do not share it with anyone.",
      Decrypt: "Decrypt",
      Password: {
        Title: "Password",
        Description:
    ...
    Errors: {
      ...
      SecretSizeLimitError: "The total size of the secret ({{size}}) exceeds the maximum allowed size of {{maxSize}}.",
    },
    ErrorPage: {
      NotFound: {
